...
function CompanyTextInput(props) {
  return (
    <>
      ...
      <input type="text" id={props.rowName} className='form-control' value={props.value} onChange={(e) => props.getChange(e.target.value, props.rowName)} required autoComplete='off' />
